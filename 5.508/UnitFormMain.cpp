...
//	ФУНКЦИОНАЛНОСТ
//
//	Тема: Прототип на приложен комуникационен протокол
//	Конфигурация "Производител - буфер - потребител" (1:2:1) с недетерминизъм
//
...
//  ПРИЛОЖНИ ЗАДАЧИ /////////////////////////////////////////////////////////
TASK*			taskP;			// задача "производител1"
TASK*			taskQ1;			// задача "буфер"
TASK*			taskQ2;			// задача "буфер"
TASK*			taskC;			// задача "потребител"

//  КОМУНИКАЦИОННИ КАНАЛИ ///////////////////////////////////////////////////
CHAN* 			chanPQ1;		// канал между P и Q1
CHAN* 			chanPQ2;		// канал между P и Q2
CHAN* 			chanQ1C;		// канал между Q1 и C
CHAN* 			chanQ2C;		// канал между Q2 и C
...
void __fastcall TformMain::buttonStartClick(TObject *Sender)
{
  ...
  taskC  = CreateTask("Task C", Task4);

  // Създаване на каналите
  chanPQ1 = CreateChan("Chan PQ1", taskP, taskQ1);
  chanPQ2 = CreateChan("Chan PQ2", taskP, taskQ2);
  chanQ1C = CreateChan("Chan Q1C", taskQ1, taskC);
  chanQ2C = CreateChan("Chan Q2C", taskQ2, taskC);
