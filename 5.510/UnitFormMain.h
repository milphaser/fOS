...
__published:	// IDE-managed Components
	...
	TGroupBox *gboxTask4;
	TProgressBar *pbarTask42;
	TStaticText *stTask42;
	TButton *buttonSuspend4;
	TButton *buttonResume4;
	TProgressBar *pbarTask41;
	TButton *buttonStop1;
	TStaticText *stTask41;
	TGroupBox *gboxTask3;
	...
	TButton *buttonStop2;
	TButton *buttonStop3;
	TProgressBar *pbarTask43;
	TStaticText *stTask43;
...
public:
	...
	bool boolTask2Stop;		// флаг на заявката за спиране на Task2
	bool boolTask3Stop;		// флаг на заявката за спиране на Task3
};
//---------------------------------------------------------------------------
