...
//	ФУНКЦИОНАЛНОСТ
//
//	Тема: Кръгова комуникация между процеси от един и същ вид
//
...
//  ПРИЛОЖНИ ЗАДАЧИ /////////////////////////////////////////////////////////
TASK*			taskP;			// задача "производител/потребител" - водеща
TASK*			taskQ;			// задача "производител/потребител"
TASK*			taskC;			// задача "производител/потребител"

//  КОМУНИКАЦИОННИ КАНАЛИ ///////////////////////////////////////////////////
CHAN* 			chanPQ;		   	// канал между P и Q
CHAN* 			chanQC;			// канал между Q и C
CHAN* 			chanCP;			// канал между C и P
...
void __fastcall TformMain::buttonStartClick(TObject *Sender)
{
  ...
  taskC  = CreateTask("Task C", Task3);

  // Създаване на каналите
  chanPQ = CreateChan("Chan PQ", taskP, taskQ);
  chanQC = CreateChan("Chan QC", taskQ, taskC);
  chanCP = CreateChan("Chan CP", taskC, taskP);
